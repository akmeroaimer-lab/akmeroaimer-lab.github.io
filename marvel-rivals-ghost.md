...
* **Sense** – встроенный Sense для отслеживания целей
* **Enable** – включение и отключение Sense
* **Outline** – отображение контура Sense
* **Background** – включение фона Sense
* **Dot Style** – стиль точки: Circle / Cross / Arrow
* **Max Distance** – настройка максимальной дистанции отображения
* **Scale** – масштаб Sense
* **Size** – настройка размера Sense
* **Dot Size** – настройка размера точки на Sense
* ⚙️ Настройки
