...
* **Custom Sense Window** – отдельное окно радара с настройкой положения
* **Rotate With Player** – Sense поворачивается вместе с игроком
...
* **Sense Styling** – сетка, кольца, северный индикатор, прозрачность и цвета
